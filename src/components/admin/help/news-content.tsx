...
// Shared body for the News help — rendered by both the standalone
// page (/admin/help/news) and the help-drawer triggered from the
// News admin page header. The wrapper that pads / sizes the content
// lives outside this file so each presentation can choose its own
// container.
    ...
    <>
      ...
      <Section title="Write a new story" anchor="new">
        ...
        <Example heading="Example">
          ...
          <Quote>
            <strong>Title:</strong> World Tai Chi Day &mdash; Saturday at the park
            <br />
...
// ---------------------------------------------------------------------------
// Presentation primitives. Co-located with the content so changes to
// either don't have to thread through unrelated files. If a second
// help topic adopts the same shapes, lift these into a shared file.
// ---------------------------------------------------------------------------

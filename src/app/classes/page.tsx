    ...
    <>
      ...
      <main id="main">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-10">
            ...
            <div className="space-y-12">
              {CLASS_LEVELS.map((level) => (
                <article
                  key={level.label}
                  className="grid grid-cols-12 gap-x-6 gap-y-6 border-t border-background/15 pt-12"
                >
        ...
        <section
          ...
          className="mx-auto max-w-7xl px-6 pb-24 md:px-10 md:pb-32"
        >
          <div className="rounded-2xl border border-foreground/10 bg-secondary p-10 md:p-14">
